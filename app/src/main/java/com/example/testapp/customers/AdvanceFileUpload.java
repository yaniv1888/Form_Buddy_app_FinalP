...
public class AdvanceFileUpload extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previous = (Button) findViewById(R.id.previous_buttonUp);
        ...
        submit = findViewById(R.id.upload2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (gallery_file_path == null) {
                    Toast.makeText(AdvanceFileUpload.this, "קובץ מגלריה לא הועלה", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (all_file_path == null) {
                    Toast.makeText(AdvanceFileUpload.this, "לא הועלה שום קובץ", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (camer_file_path == null) {
                    Toast.makeText(AdvanceFileUpload.this, "שום תמונה לא נבחרה", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void filePicker(int i) {
        if (i == 0) {
            ...
            startActivityForResult(Intent.createChooser(intent, "בחר קובץ לעלות"), ALL_FILE_REQUEST);
        }
    ...
    private void requestPermission(String permission) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AdvanceFileUpload.this, permission)) {
            Toast.makeText(AdvanceFileUpload.this, "אנא תן גישה", Toast.LENGTH_SHORT).show();
        } else {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(AdvanceFileUpload.this, "הגישה בוצעה בהצלחה", Toast.LENGTH_SHORT).show();
                    filePicker(method);
                } else {
                    Toast.makeText(AdvanceFileUpload.this, "הגישה נכשלה", Toast.LENGTH_SHORT).show();
                }
        }
    }
...
//    Now Lets Upload it First Create a Server Code for hadnling file
    ...
    public class UploadTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s==null){
                Toast.makeText(AdvanceFileUpload.this, "העלאה בוצעה בהצלחה", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(AdvanceFileUpload.this, "העלאה נכשלה", Toast.LENGTH_SHORT).show();
            }
